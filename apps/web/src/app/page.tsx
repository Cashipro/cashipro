    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm">
              <Link href="/markets" className="hover:text-cyan-400 transition-colors">Markets</Link>
              <Link href="/trade/BTCUSDT" className="hover:text-cyan-400 transition-colors">Spot</Link>
              <Link href="/futures" className="text-cyan-400 font-medium">Futures</Link>
              <Link href="/earn" className="hover:text-cyan-400 transition-colors">Earn</Link>
              <Link href="/events" className="hover:text-cyan-400 transition-colors">Event Center</Link>
              <Link href="/rewards" className="hover:text-cyan-400 transition-colors">Rewards Hub</Link>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/register">
                  <button className="group bg-white text-black px-8 py-4 rounded-2xl font-semibold flex items-center justify-center gap-3 hover:bg-cyan-400 hover:text-black transition-all text-lg">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-white/10 md:hidden z-50">
        <div className="flex items-center justify-around py-3 text-xs">
          ...
          <Link href="/trade/BTCUSDT" className="flex flex-col items-center -mt-8">
